...
import com.inocen.gojepang.activity.LoginActivity;
import com.inocen.gojepang.activity.MenuActivity;
import com.inocen.gojepang.activity.WelcomeScreenActivity;
...
public class SampleDownloaderActivity extends Activity implements IDownloaderClient {
    ...
    private static final XAPKFile[] xAPKS = {
            new XAPKFile(
                    ...
                    Constant.buildVersion, // the version of the APK that the file was uploaded
                    78459659L // the length of the file in bytes
                    //yg size, bukan size on disk
            )
    };
        ...
        AsyncTask<Object, DownloadProgressInfo, Boolean> validationTask = new AsyncTask<Object, DownloadProgressInfo, Boolean>() {
            ...
            protected void onPostExecute(Boolean result) {
                if (result) {
                    ...
                    //TODO masih visual fix buat progress bar, gk vital se
                    String temp = Long.toString(tempDPI.mOverallTotal);
                    mProgressFraction.setText(Helpers.getDownloadProgressString
                            (tempDPI.mOverallTotal,
                                    tempDPI.mOverallTotal));
                    mPB.setMax(100);
                    mPB.setProgress(100);
                    mProgressPercent.setText(100 + "%");

                    //buat langsung ke loginActivity tanpa pencet oke
                    int secondsDelayed = 1;
                    final Handler handler = new Handler();
                    handler.postDelayed(new Runnable() {
                        public void run() {
                            startActivity(new Intent(SampleDownloaderActivity.this, LoginActivity.class));
                            finish();
                        }
                    }, secondsDelayed * 500);
    ...
    private void initializeDownloadUI() {
        ...
        setContentView(R.layout.test_sample_downloader);
...
//        mRemoteService=DownloaderServiceMarshaller.CreateProxy(mDownloaderClientStub.getMessenger());
//        mRemoteService.onClientUpdated(mDownloaderClientStub.getMessenger());
        ...
        mPauseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mStatePaused) {
//                    Log.e(LOG_TAG, "continueDownload");
...
//                Log.e(LOG_TAG, "startResult " + startResult);
