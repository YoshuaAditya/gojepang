...
public class Pattern3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void initialize(){
        ...
        textViewSample3 = findViewById(R.id.textViewSample3);
        ...
        imageViewSoundPattern3 = findViewById(R.id.imageViewSoundPattern3);
        ...
        imageViewSoundPattern3.setOnClickListener(this);
    }
    ...
    public void onClick(final View v) {
        ...
        if (v==imageViewForward){
            Intent i = new Intent(this, Pattern3Part2Activity.class);
            startActivity(i);
        ...
        if (v==imageViewSoundPattern1){
            ...
            try {
                ...
                AssetFileDescriptor afd = zipResourceFile.getAssetFileDescriptor("gr01g05.mp3");
        ...
        if (v==imageViewSoundPattern2){
            ...
            try {
                zipResourceFile = APKExpansionSupport.getAPKExpansionZipFile(this, Constant.buildVersion, 0);
                AssetFileDescriptor afd = zipResourceFile.getAssetFileDescriptor("gr01g06.mp3");
                final MediaPlayer mediaPlayer = new MediaPlayer();
                mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    @Override
                    public void onCompletion(MediaPlayer mp) {
        ...
        if (v==imageViewSoundPattern3){
            ZipResourceFile zipResourceFile;
            try {
                zipResourceFile = APKExpansionSupport.getAPKExpansionZipFile(this, Constant.buildVersion, 0);
                AssetFileDescriptor afd = zipResourceFile.getAssetFileDescriptor("gr01g07.mp3");
                final MediaPlayer mediaPlayer = new MediaPlayer();
                mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    @Override
                    public void onCompletion(MediaPlayer mp) {
    ...
    private void changeKana(){
        ...
        textViewPatternExplanation.setText(getText(R.string.pattern3explanationkana));
        textViewSample1.setText(getText(R.string.pattern3sample1kana));
        textViewSample2.setText(getText(R.string.pattern3sample2kana));
        textViewSample3.setText(getText(R.string.pattern3sample2kana));
        allButtonInvisible();
    }
    private void changeRomaji(){
        textViewGrammarPattern.setText(getText(R.string.pattern3romaji));
        textViewPatternExplanation.setText(getText(R.string.pattern3explanationromaji));
        textViewSample1.setText(getText(R.string.pattern3sample1romaji));
        textViewSample2.setText(getText(R.string.pattern3sample2romaji));
        textViewSample3.setText(getText(R.string.pattern3sample2romaji));
        allButtonInvisible();
    }
    private void changeKanji(){
        textViewGrammarPattern.setText(getText(R.string.pattern3kana));
        textViewPatternExplanation.setText(getText(R.string.pattern3explanationkana));
        textViewSample1.setText(getText(R.string.pattern3sample1kanji));
        textViewSample2.setText(getText(R.string.pattern3sample2kanji));
        textViewSample3.setText(getText(R.string.pattern3sample2kanji));
        allButtonInvisible();
    }
}
