...
public class Pattern2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(final View v) {
        ...
        if (v==imageViewSoundPattern1){
            ...
            try {
                ...
                AssetFileDescriptor afd = zipResourceFile.getAssetFileDescriptor("gr01g03.mp3");
        ...
        if (v==imageViewSoundPattern2){
            ...
            try {
                zipResourceFile = APKExpansionSupport.getAPKExpansionZipFile(this, Constant.buildVersion, 0);
                AssetFileDescriptor afd = zipResourceFile.getAssetFileDescriptor("gr01g04.mp3");
                final MediaPlayer mediaPlayer = new MediaPlayer();
                mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    @Override
                    public void onCompletion(MediaPlayer mp) {
    ...
    private void changeKana(){
        textViewPatternExplanation.setText(getText(R.string.pattern2explanationkana));
        textViewGrammarPattern.setText(getText(R.string.pattern2kana));
        textViewSample1.setText(getText(R.string.pattern2sample1kana));
        textViewSample2.setText(getText(R.string.pattern2sample2kana));
        allButtonInvisible();
    }
    private void changeRomaji(){
        textViewPatternExplanation.setText(getText(R.string.pattern2explanationromaji));
        textViewGrammarPattern.setText(getText(R.string.pattern2romaji));
        textViewSample1.setText(getText(R.string.pattern2sample1romaji));
        textViewSample2.setText(getText(R.string.pattern2sample2romaji));
        allButtonInvisible();
    }
    private void changeKanji(){
        textViewPatternExplanation.setText(getText(R.string.pattern2explanationkana));
        textViewGrammarPattern.setText(getText(R.string.pattern2kana));
        textViewSample1.setText(getText(R.string.pattern2sample1kanji));
        textViewSample2.setText(getText(R.string.pattern2sample2kanji));
        allButtonInvisible();
    }
}
