...
public class Pattern4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(final View v) {
        ...
        if (v==imageViewForward){
            Intent i = new Intent(this, Pattern5Activity.class);
            startActivity(i);
        ...
        if (v==imageViewSoundPattern1){
            ...
            try {
                ...
                AssetFileDescriptor afd = zipResourceFile.getAssetFileDescriptor("gr01g09.mp3");
    ...
    private void changeKana(){
        textViewPatternExplanation.setText(getText(R.string.pattern4explanationkana));
        textViewGrammarPattern.setText(getText(R.string.pattern4kana));
        textViewSample1.setText(getText(R.string.pattern4sample1kana));
        textViewSample2.setText(getText(R.string.pattern4sample2kana));
        allButtonInvisible();
    }
    private void changeRomaji(){
        textViewPatternExplanation.setText(getText(R.string.pattern4explanationromaji));
        textViewGrammarPattern.setText(getText(R.string.pattern4romaji));
        textViewSample1.setText(getText(R.string.pattern4sample1romaji));
        textViewSample2.setText(getText(R.string.pattern4sample2romaji));
        allButtonInvisible();
    }
    private void changeKanji(){
        textViewPatternExplanation.setText(getText(R.string.pattern4explanationkana));
        textViewGrammarPattern.setText(getText(R.string.pattern4kana));
        textViewSample1.setText(getText(R.string.pattern4sample1kanji));
        textViewSample2.setText(getText(R.string.pattern4sample2kanji));
        allButtonInvisible();
    }
}
