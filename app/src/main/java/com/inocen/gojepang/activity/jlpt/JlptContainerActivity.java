...
public class JlptContainerActivity extends AppCompatActivity {
    ...
    JlptQuestionFragment jlptQuestionFragment;
    JlptResultFragment jlptResultFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (readJsonSuccess) {
            ...
            jlptQuestionFragment = new JlptQuestionFragment();
            jlptResultFragment = new JlptResultFragment();
            fragmentTransaction.add(R.id.container, jlptQuestionFragment);
            fragmentTransaction.add(R.id.container, jlptResultFragment);
            fragmentTransaction.detach(jlptResultFragment);
            fragmentTransaction.attach(jlptQuestionFragment);
            fragmentTransaction.addToBackStack(null);
            fragmentTransaction.commit();
//            Log.e("GOJEPANG", "" + arrayListSoal.size());
        } else {
            Toast.makeText(JlptContainerActivity.this, "Coming soon",
