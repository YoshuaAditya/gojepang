...
public class KanjiYomikataFragment extends Fragment {
    ...
    public KanjiYomikataFragment() {
        // Required empty public constructor
    }

    public static KanjiYomikataFragment newInstance(String param1, String param2) {
        KanjiYomikataFragment fragment = new KanjiYomikataFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_kanji_new_card_yomikata_layout, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedState) {
        ...
        kanjiContainerActivity.currentKanjiLeafNumber++;
        checkReplay();
        initializeOnClick();
        setTextKanji();
    }
     ...
     */
    void setTextKanji() {
        buttonCard.setText(KanjiIntroActivity.arrayListKanjiRoot.get(kanjiContainerActivity.currentKanjiNodeNumber)
    ...
    private void initializeOnClick() {
        buttonCard = getActivity().findViewById(R.id.card);
        buttonCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fragmentManager = getActivity().getSupportFragmentManager();
                fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.detach(kanjiContainerActivity.kanjiYomikataFragment);
                fragmentTransaction.attach(kanjiContainerActivity.kanjiYomikataFlipFragment);
